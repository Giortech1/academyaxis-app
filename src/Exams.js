...
function Exams() {
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'row', height: '100%' }}>
            ...
            {/* Main content */}
            <main style={{ flexGrow: 1, padding: '5px', width: '100%' }}>
                ...
                <section1 style={{ display: 'flex', padding: '12px', width: '100%', overflow: 'hidden', justifyContent: 'center', paddingTop: '0px' }} id="exams-section1">
                    <section
                        style={{
                            display: 'flex',
                    ...
                    <div id="exam-calendar" style={{ display: 'flex', flexDirection: 'column', paddingLeft: '14px' }}>
