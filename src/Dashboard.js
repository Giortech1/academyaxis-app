    ...
    `}
                    ...
                    <Row>
                        ...
                        <Col md={6} style={{ marginTop: '20px' }}>
                            <div className="p-0" style={{ border: '1px solid #E5E7EB', borderRadius: '12px', minHeight: '315px' }}>
                                <section style={{ display: 'flex', padding: '12px', width: '100%', justifyContent: 'center' }} id="exams-section1">
                                    <section style={{ fontFamily: 'Inter', width: '100%' }}>
                                        {/* Header */}
                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
                                            <h2 style={{ fontSize: '16px', fontWeight: '600', color: '#000' }}>Exams</h2>
                                            <button style={{ background: 'none', border: 'none', color: 'rgb(17, 24, 39)', fontWeight: '500', fontSize: '12px', cursor: 'pointer', textDecoration: 'underline' }}>
                                                View All
                                            </button>
                                        </div>

                                        {/* Exam Rows */}
                                        {examData.map((dayItem, index) => (
                                            <div key={index} id='exams' style={{ display: 'flex', alignItems: 'center', marginBottom: '16px', gap: '24px' }}>
                                                {/* Date Column */}
                                                <div style={{ width: '160px', minWidth: '160px' }}>
                                                    <h4 style={{ margin: 0, fontSize: '14px', fontWeight: '600', color: '#111827' }}>{dayItem.day}</h4>
                                                    <p style={{ margin: 0, fontSize: '12px', color: '#475467', marginTop: '4px', fontWeight: '400' }}>{dayItem.date}</p>
                                                </div>

                                                {/* Exams Column */}
                                                <div id='exam-column' style={{ display: 'flex', gap: '16px', flex: 1 }}>
                                                    {dayItem.exams.map((exam, examIndex) => (
                                                        <div
                                                        id='examindex'
                                                            key={examIndex}
                                                            style={{
                                                                backgroundColor: exam.bgColor,
                                                                border: `1.5px solid ${exam.borderColor}`,
                                                                borderRadius: '16px',
                                                                padding: '16px 20px',
                                                                width: dayItem.exams.length === 1 ? '100%' : '100%', // Full width if only 1 exam
                                                                display: 'flex',
                                                                flexDirection: 'column',
                                                                justifyContent: 'space-between',
                                                            }}
                                                        >
                                                            {/* Title */}
                                                            <h3 style={{ margin: 0, fontSize: '14px', fontWeight: '600', color: '#111827' }}>{exam.title}</h3>
                                                            {/* Time */}
                                                            <p style={{ margin: 0, fontSize: '12px', color: '#475467', marginTop: '10px', fontWeight: '400' }}>{exam.time}</p>
                                                        </div>
                                                    ))}
                                                </div>
                                            </div>
                        ...
                        <Col md={6} style={{ marginTop: '20px' }}>
                            ...
                            >
                                <Card.Body>
                                    ...
                                    <div
                                        style={{
                                            maxHeight: exams.length > 3 ? '275px' : 'none',
                        ...
                        <Col md={6} style={{ marginTop: '20px' }}>
                            <Card style={{ border: 'none', }}>
                                <Card.Body style={{ padding: '0px' }}>
                                    ...
                                    >
                                        {/* Heading */}
                                        <div className="d-flex justify-content-between align-items-center mb-0" id='course-heading'>
                                            <h5 style={{ fontWeight: "500", fontSize: "16px", margin: 0 }}>Enrolled Courses</h5>
                                            <button
                                                className="btn border-0"
                                                style={{
                                                    fontSize: '12px',
                                                ...
                                                onClick={() => navigate("/coursedetails")} // Navigate to Coursedetails.js
                                            >
                                                View All
                                            </button>
                                        </div>
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                >
                                                    <tr>
                                                        {["Course Name", "Course ID", "Enrolled Date", "Status"].map((heading, index) => (
                                                            <th
                                                                key={index}
                                                                style={{
                                                                    fontWeight: "500",
                                                ...
                                                <tbody>
                                                    {courses.map((course, index) => {
                                                        const formattedDate = new Date(course.date).toLocaleDateString("en-GB");
                                                        return (
                                                            <tr key={index}>
                                                                {/* Course Name */}
                                                                <td
                                                                ...
                                                                >
                                                                    <span
                                                                        style={{
                                                                            ...
                                                                            height: "8px",
                                                                            borderRadius: "50%",
                                                                            backgroundColor: "#FDB022", // Yellow dot
                                                                            marginRight: "5px",
                                                                        }}
                                                                    ></span>
                                                                    {course.status === "Ongoing" ? "In Progress" : course.status}
                                                                </td>
                                                            </tr>
                                                        );
                                                    })}
