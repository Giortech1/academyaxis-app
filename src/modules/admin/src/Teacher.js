    ...
    return (
        <Container fluid className="p-3 d-flex">
            <main className="flex-grow-1 ">
                {/* Header Section */}
                <header
                    className="d-flex flex-wrap justify-content-between align-items-center  mb-4 w-100"
                    style={{ paddingTop: "0px" }}
                >
                    <div className="d-flex align-items-center mb-2 mb-md-0">
                        <h1 style={{ fontSize: "24px", margin: 0, fontWeight: "600" }}>Teachers</h1>
                    </div>
                                    ...
                                    <tr key={classItem.id} style={{ borderBottom: "1px solid #ddd" }}>
                                        ...
                                        >
                                            <Button
                                                ...
                                                onClick={() => navigate(`/teacher-details/${classItem.id}`)}
                                            >
                                                <img
