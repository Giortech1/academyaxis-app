  ...
  return (
    ...
    >
      ...
      <div className="mt-auto">
        ...
        <Nav.Link
          ...
          className={`d-flex align-items-center py-2 px-3 rounded mb-2 ${activeButton === 12 ? "bg-#344054" : ""
            }`}
          style={{
            height: "50px",
            color: "white",
    ...
    `}
        ...
        <Nav.Link
          ...
          className={`d-flex align-items-center py-2 px-3 rounded ${activeButton === 13 ? "bg-#344054" : ""
            }`}
          style={{
            height: "50px",
            color: "white",
            cursor: "pointer",
            backgroundColor: activeButton === 13 ? "#344054" : "",
          }}
        >
          <img
            src="/assets/Support.png" 
