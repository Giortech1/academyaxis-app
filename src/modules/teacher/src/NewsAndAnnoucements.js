...
const NewsAndAnnouncements = () => {
    ...
    return (
        <div style={{ padding: "15px" }}>
            ...
            {/* Second Header - Added as per Figma design */}
                ...
                <div className="d-flex">
                    ...
                    >
                        <Image
                            ...
                            alt="Sort"
                        />
                        <span style={{ fontSize: "14px", color: "#374151", fontWeight:'600' }}>Sort</span>
                    </Button>
                    <Button 
                        variant="primary" 
                        style={{ 
                            ...
                            fontSize:'14px', fontWeight:'600'
                                                ...
                                                onClick={() => navigate('/teacher-news-and-announcements')}
                    ...
                    >
                        <Image
                            ...
                            alt="Add"
                        />
                        <span style={{ fontSize: "14px" }}>Add Announcement</span>
                    </Button>
                </div>
            </div>
