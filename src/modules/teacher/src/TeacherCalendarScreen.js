...
const CalendarScreen = () => {
    ...
    // Update today's classes when sections or selected date changes
    useEffect(() => {
        const classes = convertSectionsToClasses();
        ...
        <Container fluid className="p-4">
            ...
            <header className="d-flex justify-content-between align-items-center mb-4">
                ...
                <div style={{ display: 'flex' }}>
                    <div
                        className="calendar-nav-button active"
                        onClick={handleClick}
                    >
                        <img
                    ...
                    <Card className="classes-card">
                        ...
                        {todayClasses.length === 0 ? (
                            <div className="no-classes">
                                <p>No classes scheduled for {getCurrentDayName()}</p>
                            </div>
                        ) : (
                                ...
                                >
                                    ...
                                    <div className="class-details">
                                        ...
                                        <p className="room-info">
                                            {classInfo.room} • {classInfo.department} • Section {classInfo.section}
                                        </p>
                                        <div className="d-flex align-items-center">
                                            <img
