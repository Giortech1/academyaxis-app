...
const Feechallan = () => {
    ...
    return (
        <div className="d-flex">
            ...
            <Container fluid className="p-4" id="feechallan">
                ...
                {/* Table Section */}
                <Card className=" mb-4 shadow-sm " style={{ border: '1px solid #E5E7EB', borderRadius: '12px' }}>
  ...
  `}
                ...
                <Row>
                    ...
                    <Col md={6}>
                        <Card className="p-2 mb-3">
                            <div style={{
                                ...
                                <img
                                    src="/assets/dots-vertical.png" // Replace with your actual image path
                                    alt="Menu Dots"
                                    style={{
                                        width: "20px", // Adjust size as per your design
                                        height: "20px",
                                    }}
                                />
                            </div>
                    ...
                    {/* Upcoming Fees */}
                    <Col md={6}>
                        <Card className="p-2 " style={{ borderWidth: '1px', borderRadius: '12px solid #E5E7EB' }}>
                            <div style={{
                                display: "flex",
                                justifyContent: "space-between",
                                alignItems: "center",
