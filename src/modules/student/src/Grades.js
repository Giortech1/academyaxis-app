  ...
  return (
    <Container fluid className="p-3" id="gradescontainer">
      ...
      <header className="d-flex justify-content-between align-items-center mb-4" id="gradesheader">
        {/* Left: Month and Year */}
        <div className="d-flex align-items-center" style={{ border: '1px solid #E5E7EB', borderRadius: '8px', height: '35px', padding: '10px' }}>
          <Image
        ...
        <div className="d-flex align-items-center" id="gradesearch">
          <div className="position-relative me-3" style={{ flexGrow: 1 }}>
            <Form.Control
              ...
              type="text"
              placeholder="Search"
              style={{ borderRadius: "8px", paddingLeft: "40px", fontSize: '16px', fontWeight: '400', color: '#98A2B3', borderColor: '#E5E7EB', width: '300px' }}
            />
            <Image
      ...
      <Row id="graderow">
        ...
        <Col lg={8} className="position-relative">
          <Card className="p-3  position-relative" id="grademetrics" style={{ overflow: "hidden", border: '1px solid #EAECF0', borderRadius: '16px', minHeight: '263px', justifyContent: 'center' }}>
        ...
        {/* GPA Chart */}
        <Col lg={4} md={6} sm={12}>
          <Card className="p-3  text-center " style={{ border: '1px solid #EAECF0', borderRadius: '12px' }}>
