...
function Quizzes() {
  ...
  return (
    <Container fluid className="p-3">
      ...
      <div className="px-0">
        <div className=" p-3" style={{ minHeight: "750px", border: '1px solid #EAECF0', borderRadius: '12px' }}>
            ...
            >
              <thead style={{ position: "sticky", top: 0, background: "#FFFFFF", zIndex: 1 }}>
                <tr>
                  ...
                  <th style={{fontSize:'16px', fontWeight:'500', color:'111827'}}>Type</th>
                  <th style={{fontSize:'16px', fontWeight:'500', color:'111827'}}>Status</th>
                  <th style={{fontSize:'16px', fontWeight:'500', color:'111827'}}>Actions</th>
                </tr>
              </thead>
              <tbody>
