...
function Assignments() {
  ...
  return (
    <Container fluid className="p-3">
      {/* Header Section */}
      <header className="d-flex justify-content-end align-items-center p-0 mb-3" >
      ...
      <div className="px-0">
        <div className="assignment-table " style={{ minHeight: "750px", border: '1px solid #EAECF0', borderRadius: '12px', padding:'12px', marginTop:'20px' }}>
            ...
            >
              ...
              >
                <tr>
                  ...
                  <th style={{fontSize:'16px', fontWeight:'500', color:'#111827'}}>Teacher</th>
                  <th style={{fontSize:'16px', fontWeight:'500', color:'#111827'}}>Due Date</th>
                  ...
                  <th style={{fontSize:'16px', fontWeight:'500', color:'#111827'}}>Action</th>
                </tr>
              </thead>
              <tbody>
