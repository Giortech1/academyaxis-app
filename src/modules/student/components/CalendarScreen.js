...
const CalendarScreen = () => {
    ...
    return (
        <Container fluid className="p-3" id="calendarscreen">
            {/* Header Section */}
            ...
            <header className="d-flex justify-content-between align-items-center mb-4" id="second-header">
                ...
                <div id="calendarsort" className="d-flex align-items-center" style={{gap:'14px'}}>
                    <div className="position-relative me-0" style={{ flexGrow: 1 }} >
                        <Form.Control
                        id="search-container"
                            type="text"
                            placeholder="Search"
            ...
            <Row>
                ...
                <Col md={8} id="calendar">
                    <Card className="calendar-section " style={{ borderRadius: "10px" }}>
