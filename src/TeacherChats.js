...
const Chat = () => {
    ...
    const handleDropdownAction = (action) => {
        // Here you can implement the actual functionality for each action
        alert(`Action: ${action} for chat with ${selectedUser?.name}`);
        setShowDropdown(false);
    };
    ...
    return (
        <div className="chat-container vh-100 d-flex justify-content-center align-items-center">
                    ...
                    <Col xs={12} md={8} className="p-0 d-flex flex-column h-100">
                        ...
                        <div className="d-flex justify-content-between align-items-center p-3 ">
                            ...
                            <div style={{ position: "relative" }} ref={dropdownRef}>
                                <img src="/assets/Search3.png" alt="Search" style={{ width: "20px", marginRight: "15px", cursor: "pointer" }} />
                                <img 
                                ...
                                {showDropdown && (
                                    ...
                                    >
                                        <div 
                                            onClick={() => handleDropdownAction("Pin Chat")}
                                            style={{ 
                                                padding: "8px 16px", 
                                                cursor: "pointer",
                                                fontSize: "14px",
            ...
            {/* Styled JSX for Mobile and Dropdown */}
            <style jsx>{`
