    ...
    return (
        ...
        <div style={{ padding: "20px", margin: "0 auto" }}>
            ...
            <Form>
                ...
                <div className="mb-4 col-7" style={{ display: 'flex', justifyContent: 'space-between', marginTop: '20px' }}>
                ...
                <div className="mb-4 col-7" style={{ display: 'flex', marginTop: '20px', justifyContent: 'space-between' }}>
                ...
                {/* Photo Section */}
                {/* Photo Section */}
                <div className="d-flex align-items-center justify-content-between mb-4 col-7" style={{ marginTop: '20px' }}>
                ...
                <div className="mb-4 col-7" style={{ marginTop: '20px' }}>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                        ...
                        <InputGroup style={{ border: "1px solid #D1D5DB", borderRadius: "8px", padding: "0px 12px", height: '40px', width: '50%' }}>
