...
function QuizDetails() {
    ...
    const { userData, refreshSections, updateQuizById } = useContext(UserContext);
    ...
    const isSubmitted = quiz?.category === "Submitted";
    const isOverdue = quiz?.category === "Overdue";
    const isUpcoming = quiz?.category === "Upcoming";
    const submittedData = quiz?.submittedData || null;
    ...
    const handleSubmitQuiz = async () => {
        ...
        try {
            ...
            const uploadOptions = {
                ...
                nameSlug: `${quiz.name.replace(/\s+/g, '_')}_${quiz.id}`
            };
            ...
            const response = await updateQuizById(sectionId, quiz?.id, submissionData);
            ...
            return (
                <div style={{
                    ...
                    <p style={{ color: '#991B1B', fontSize: '14px', margin: '4px 0 0 0' }}>
                        The deadline for this quiz has passed. You can no longer submit your work.
                    </p>
                </div>
            );
        }
            ...
            <Container fluid style={styles.container}>
                <div style={styles.mainContent}>
                    <div style={{ textAlign: 'center', padding: '40px' }}>
                        ...
                        <p>The quiz details could not be loaded.</p>
            ...
            <main style={styles.mainContent}>
                ...
                <header style={styles.header}>
                    <div style={styles.headerLeft}>
                        ...
                        />
                        <h1 style={styles.headerTitle}>Quiz Details</h1>
                    </div>
                        ...
                        <div style={styles.quizCard}>
                            ...
                            <div style={styles.section}>
                                ...
                                <div style={styles.sectionText}>
                                    {quiz.description || "Please follow the instructions carefully and submit your work before the deadline."}
                                </div>
                            ...
                            <div style={styles.section}>
                                ...
                                <div style={styles.sectionText}>
                                    {quiz.department} • Section {quiz.section}
                                </div>
                            </div>
                        ...
                        <Col lg={12} md={12} style={styles.submitSection}>
                            <div style={styles.submitCard}>
                                <div style={styles.submitHeader}>
                                    <h4 style={styles.submitTitle}>Submit Quiz</h4>
                                </div>
                                ...
                                <div style={styles.fileUpload}>
                                    ...
                                    <p style={styles.uploadText}>
                                        {isSubmitted ? 'Quiz has been submitted' :
                                            isOverdue ? 'Quiz is overdue' :
                    ...
                    <Col lg={4} md={12}>
                        <div style={styles.timeLeftCard}>
                            ...
                            <div style={styles.timeDescription}>
                                {isSubmitted ? 'Great job! You have successfully submitted your quiz.' :
                                    isOverdue ? 'This quiz is overdue. Please contact your teacher for further assistance.' :
                            ...
                            <div style={styles.teacherInfo}>
                                <img
                                    src={quiz.teacherProfile || "/assets/avatar.jpeg"}
                                    alt="Teacher Avatar"
