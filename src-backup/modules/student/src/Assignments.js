...
function Assignments() {
  ...
  const convertSectionsToAssignments = () => {
  ...
  useEffect(() => {
    const assignments = convertSectionsToAssignments();
    setTableData(assignments);
  }, [sections, userData]);

  const handleViewClick = (assignment) => {
    navigate(`/assignments/details/${assignment.id}`, {
      state: {
        assignment,
        ...
        <div style={styles.assignmentTable}>
          ...
          <div style={styles.tableContainer}>
            {tableData.length === 0 ? (
              ...
              <div style={styles.noAssignments}>
                <p>No {activeFilter.toLowerCase()} assignments found</p>
              </div>
            ) : (
              <Table
                hover
