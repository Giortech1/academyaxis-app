...
function AllSectionQuizzes() {
    ...
    const handleCardClick = (data) => {
        navigate(`/TeacherQuizzes/${data?.id}`);
    };
    ...
    useEffect(() => {
        ...
        setQuizzesData(convertedData);
        setFilteredData(convertedData);
    }, [sections]);

    useEffect(() => {
        const filtered = filterData(quizzesData, searchText);
        setFilteredData(filtered);
    }, [searchText, quizzesData]);
...
export default AllSectionQuizzes;