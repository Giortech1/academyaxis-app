...
function AllSectionAssignments() {
    ...
    const handleCardClick = (data) => {
        navigate(`/TeacherAssignments/${data?.id}`);
    };
    ...
    useEffect(() => {
        const convertedData = convertSectionsData();
        setAssigmentData(convertedData);
        setFilteredData(convertedData);
    }, [sections]);

    useEffect(() => {
        const filtered = filterData(assigmentData, searchText);
        setFilteredData(filtered);
    }, [searchText, assigmentData]);
            ...
            <main className="flex-grow-1 p-3">
                ...
                <header className="main-header">
                    <div className="header-left">
                        <h1 className="page-title">Assigments</h1>
                    </div>
...
export default AllSectionAssignments;