                    ...
                    return (
                        <Card
                            ...
                            style={{
                                ...
                                borderRadius: "8px",
                                height: "152px", // Fixed height as requested
                                position: "absolute",
                                top: "4px",
                                left: "4px",
                                right: "4px",
                                                ...
                                                {eventColors.map(color => (
                                                    <div
                                                        ...
                                                        style={{
                                                            ...
                                                            borderRadius: '50%',
                                                            cursor: 'pointer',
                                                            border: formData.color === color.value ? '1px solid #7F56D9' : '1px solid #fff'
                                                        }}
            ...
            >
                <div className="d-flex justify-content-between align-items-center">
                    <div className="d-flex align-items-center">
                        ...
                        >
                            <img src="/assets/delete1.png" alt="Delete" width="24" height="24" style={{ filter: 'brightness(0) invert(1)' }} />
                        </div>
                        <h5 style={{ margin: 0, fontSize: '24px', fontWeight: '700', color: 'white' }}>
                            Delete Classes
                        </h5>
                    </div>
                    <button
                ...
                <p style={{ 
                    ...
                    Select a class below to remove it from your schedule
                </p>
            </div>
            ...
            <div style={{ padding: '24px' }}>
                {events.length === 0 ? (
                    <div style={{ 
                        ...
                        <h6 style={{ fontSize: '16px', fontWeight: '600', color: '#475569', marginBottom: '8px' }}>
                            No Classes Found
                        </h6>
                        <p style={{ fontSize: '14px', color: '#64748b', margin: 0 }}>
                            There are no classes available to delete at the moment.
                        </p>
                    </div>
                ) : (
                        ...
                        {events.map((event, index) => {
                            ...
                            return (
                                <div
                                    ...
                                    onClick={() => {
                                        if (window.confirm(`⚠️ Are you sure you want to delete "${event.subject}"?\n\nThis action cannot be undone.`)) {
                                        ...
                                        <div style={{ flex: 1 }}>
                                            ...
                                            <div style={{ display: 'flex', alignItems: 'center', marginBottom: '8px' }}>
                                                <div style={{
                                                    ...
                                                    <img src="/assets/book1.png" alt="Course" width="16" height="16" />
                                                </div>
                                                <h6 style={{ 
                                                    margin: 0, 
                                                    fontSize: '16px', 
