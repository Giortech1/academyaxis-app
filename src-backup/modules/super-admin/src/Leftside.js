...
function AdminSidebar({ activeButton, setActiveButton, toggleSidebar }) {
  ...
  const buttons = [
    ...
    { id: 7, icon: "/assets/admin.png", text: "Admin", link: "/Admin" },
    { id: 8, icon: "/assets/fee.png", text: "Fees", link: "/Fees" },
    { id: 9, icon: "/assets/fee.png", text: "Fees Management", link: "/FeesManagement" },
    { id: 10, icon: "/assets/ares.png", text: "Department & Rooms", link: "/department&room" },
    { id: 11, icon: "/assets/support.png", text: "Support", link: "/support" },
    { id: 12, icon: "/assets/settings.png", text: "Settings", link: "/settings" },
  ];
