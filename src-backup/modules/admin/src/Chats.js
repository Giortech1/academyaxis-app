                    ...
                    {isSearching ? (
                        ...
                        <div className="search-results">
                            {searchResults.map(user => (
                                ...
                                >
                                    <img
                                        src={user.profile_pic || "/assets/Avatar5.png"}
                                        alt="Avatar"
                                        className="search-avatar"
                                    />
                                    <div className="search-info">
                                        <div className="search-name">{user.full_name || user.email}</div>
                                        <div className="search-email">{user.student_id || user.teacher_id || user.admin_id}</div>
                                    </div>
                                </div>
                            ))}
