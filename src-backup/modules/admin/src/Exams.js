...
function Exams() {
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'row', height: '100%' }}>
            ...
            {/* Main content */}
            <main style={{ flexGrow: 1, padding: '12px', width: '100%' }}>
                ...
                <section1 style={{ display: 'flex', padding: '0px', width: '100%', overflow: 'hidden', justifyContent: 'center', paddingTop: '0px' }} id="exams-section1">
                    <section
                        style={{
                            display: 'flex',
                    ...
                    >
                        ...
                        {[...Array(4)].map((_, index) => (
                            <div id="remaining-cards"
                                key={index}
                                style={{
                                    borderBottom: index === 3 ? 'none' : '1px solid #EAECF0', // Dynamically setting the borderBottom for the last card
                                    display: 'flex',
                    ...
                    <div id="exam-calendar" style={{ display: 'flex', flexDirection: 'column', paddingLeft: '22px' }}>
